...
public class QMember extends EntityPathBase<Member> {
    ...
    private static final long serialVersionUID = 1589257564L;
    ...
    public final ListPath<Prep, QPrep> preps = this.<Prep, QPrep>createList("preps", Prep.class, QPrep.class, PathInits.DIRECT2);
    ...
    public QMember(Path<Member> path) {
